...
public class BytesConstantTimeSelect0SuccinctBitVector implements Externalizable, SuccinctBitVector {
    ...
    public BytesConstantTimeSelect0SuccinctBitVector(
            ...
            int node3pos,
            int[] countCache0,
            SuccinctBitVector bvD,
            SuccinctBitVector bvR,
            boolean first0bitInBlock,
            boolean prevBsC,
            boolean currentBsC,
            int[] arS,
            int arSSize) {
