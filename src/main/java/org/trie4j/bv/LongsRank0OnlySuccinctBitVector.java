...
public class LongsRank0OnlySuccinctBitVector implements Serializable, SuccinctBitVector {
    ...
    public LongsRank0OnlySuccinctBitVector(long[] longs, int size, int size0, int[] countCache0) {
        this.longs = longs;
        this.size = size;
        this.size0 = size0;
