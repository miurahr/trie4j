    ...
    public static class Node implements Serializable {
        ...
        public Node insertChild(StringBuilder tails, int childIndex, CharSequence letters, int begin, int offset) {
            ...
            while (matchedCount < n
                    && (c = letters.charAt(offset - matchedCount) - tails.charAt(this.last - matchedCount)) == 0)
                matchedCount++;
            if (matchedCount == n) {
            ...
            if (matchedCount == 0) {
                ...
                if (tails.charAt(cont) == '\0') {
                    ...
                    tails.append('\1').append(tails.charAt(cont + 1)).append(tails.charAt(cont + 2));
                } else {
                    tails.append('\1').append((char) (cont & 0xffff)).append((char) ((cont & 0xffff0000) >> 16));
                }
                // */
            } else {
        ...
        private Node addChild(
                StringBuilder tails, int index, CharSequence letters, int min, int offset, int matchedCount) {
