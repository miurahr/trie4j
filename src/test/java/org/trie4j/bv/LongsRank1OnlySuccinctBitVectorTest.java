...
public class LongsRank1OnlySuccinctBitVectorTest { // extends AbstractSuccinctBitVectorTest{
    ...
    public void test_1() throws Exception {
        ...
        bs.set(34);
        bs.set(67);
        LongsRank0OnlySuccinctBitVector bv = new LongsRank0OnlySuccinctBitVector(bs.getBytes(), bs.size());
    ...
    public void test_2() throws Exception {
        LongsRank0OnlySuccinctBitVector bv =
                new LongsRank0OnlySuccinctBitVector(new byte[] {127, -12, -102, -1, -6, 95, -1, -33, -128}, 65);
    ...
    public void test_from_bytes_rank_1() throws Exception {
        SuccinctBitVector sbv = new LongsRank0OnlySuccinctBitVector(
                new byte[] {0x01, 0x1f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, (byte) 0x80}, 68);
