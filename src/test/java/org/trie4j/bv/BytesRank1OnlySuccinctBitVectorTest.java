...
public class BytesRank1OnlySuccinctBitVectorTest {
    ...
    public void test_1() throws Exception {
        ...
        bs.set(34);
        bs.set(67);
        BytesRank1OnlySuccinctBitVector bv = new BytesRank1OnlySuccinctBitVector(bs.getBytes(), bs.size());
    ...
    public void test_2() throws Exception {
        BytesRank1OnlySuccinctBitVector bv =
                new BytesRank1OnlySuccinctBitVector(new byte[] {127, -12, -102, -1, -6, 95, -1, -33, -128}, 65);
