...
public class TailLOUDSPPTrieWithConcatTailArrayTest extends AbstractTermIdTrieTest<TailLOUDSTrie> {
    @Override
    protected TailLOUDSTrie buildSecond(Trie firstTrie) {
        return new TailLOUDSTrie(firstTrie, new LOUDSPPBvTree(firstTrie.nodeSize()), new ConcatTailArrayBuilder());
    }
