...
public abstract class AbstractTrieTest<F extends Trie, S extends Trie> {
    ...
    public void test_findShortestWord_2() throws Exception {
        String[] expected = {"ソフトウェア", "オープンソース", "ソフトウェア", "Linux", "Linux", "ファイル", "ファイル", "ファイル", "Linux"};
        Trie t = trieWithWords(
                "ソフトウェア",
                "ソフトウェアコンテナ",
                "オープンソース",
    ...
    public void test_findLongestWord_2() throws Exception {
        String[] expected = {
            "ソフトウェアコンテナ", "オープンソースソフトウェア", "Linuxカーネル", "Linuxコンテナ技術", "ファイルシステム", "ファイル", "ファイル", "Linuxカーネル"
        };
        Trie t = trieWithWords(
                "ソフトウェア",
                "ソフトウェアコンテナ",
    ...
    static {
        try (BufferedReader r = new BufferedReader(new InputStreamReader(
                AbstractTrieTest.class.getResourceAsStream("AbstractTrieTest_longsentences.txt"), "UTF-8"))) {
